...
CONTRACTS_DIR="$SCRIPT_DIR/../../debug_tools/test-contracts"
cd "$CONTRACTS_DIR"

# Simply use contracts/selfdestruct.sol:SelfDestruct since we know the structure
# The CONTRACT_FQN should be in format: .../contracts/selfdestruct.sol:SelfDestruct
# We want to extract: contracts/selfdestruct.sol:SelfDestruct
CONTRACT_RELATIVE="contracts/selfdestruct.sol:SelfDestruct"
